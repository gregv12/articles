...
public class Csv2AssetPrice implements EventHandler, BatchHandler, Lifecycle {

  //Node declarations
  private final AssetPriceCsvDecoder0 assetPriceCsvDecoder0_0 = new AssetPriceCsvDecoder0();
  ...
  //Dirty flags
  private boolean isDirty_assetPriceCsvDecoder0_0 = false;
  private boolean isDirty_eventPublsher_1 = false;
  private boolean isDirty_validationLogSink_3 = false;
  //Filter constants

  public Csv2AssetPrice() {
    assetPriceCsvDecoder0_0.errorLog = validationLogger_2;
  ...
  public void handleEvent(CharEvent typedEvent) {
    ...
    isDirty_assetPriceCsvDecoder0_0 = assetPriceCsvDecoder0_0.charEvent(typedEvent);
    if (isDirty_assetPriceCsvDecoder0_0) {
      eventPublsher_1.wrapperUpdate(assetPriceCsvDecoder0_0);
    }
  ...
  public void handleEvent(EofEvent typedEvent) {
    //Default, no filter methods
    isDirty_assetPriceCsvDecoder0_0 = assetPriceCsvDecoder0_0.eof(typedEvent);
    if (isDirty_assetPriceCsvDecoder0_0) {
      eventPublsher_1.wrapperUpdate(assetPriceCsvDecoder0_0);
    }
    //event stack unwind callbacks
  ...
  public void afterEvent() {
    ...
    isDirty_assetPriceCsvDecoder0_0 = false;
