...
public class LogMsgBuilder8 extends LogMsgBuilder {
  ...
  public boolean logMessage() {
    if (notificationToLog & isGoodToLog()) {
      ...
      msgSink.append(
          ((java.lang.Number) source_Map_doubleValue_With_subtract0_7.event()).intValue());
      msgSink.append("");
